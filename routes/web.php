...
Route::get('/stock/manage/edit/{id}',[StockController::class,'stockedit'])->name('stock.edit');
//Route::get('/customer/delete/{id}',[StockController::class,'stockdelete'])->name('customer.delete');
Route::put('/stock/manage/update/{id}',[StockController::class,'stockupdate'])->name('stock.update');
