...
<div class="" role="">
    <div class="">
        <div class="page-title" style="text-align: center; color:white;">
            ...
            <h3 style="text-transform: uppercase; font-weight: bold;">Manage Purchase</h3>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <table class="table">
                            <span class="section" style="color:black; font-weight: bold;">All Purchases</span>
                            ...
                            @foreach ($purchasehistories as $purchasehistory)
                                ...
                                <td>{{ $loop->iteration }}</td>
                                    ...
                                    <td>
                            <a href="{{route('details', $purchasehistory->id)}}"><i class="fa fa-list" style="font-size:24px;color:darkblue;font-weight:800"></i></a>
