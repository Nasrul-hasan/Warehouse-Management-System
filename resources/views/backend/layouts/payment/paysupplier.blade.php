                    ...
                    {{-- <form role="form" action="{{route('paymanage')}}" method="post"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input readonly type="text" class="form-control" id="type" name="type" placeholder=""
                                    autocomplete="off" value="supplier">
                            </div>

                            <div class="form-group">
                                <label for="suppliername">Supplier</label>
                                <input readonly type="text" class="form-control" id="supplier_name" name="name"
                                    placeholder="" autocomplete="off" value="{{$buys->supplier->name}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input readonly type="text" class="form-control" id="amount" name="amount"
                                    placeholder="" autocomplete="off" value="{{$buys->total_price}}">
                            </div>
