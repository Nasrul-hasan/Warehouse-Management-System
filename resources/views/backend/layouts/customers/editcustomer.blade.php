...
<div class="" role="">
    <div class="">
        <div class="page-title">
            <div class="">
                <h3  style="color: white; font-weight:800; text-align:center;">Edit Customers</h3>
            </div>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{route('customer.update',$customers->id)}}" method="post" class="form-horizontal form-label-left"
                            ...
                            <span class="section" style="color: black; font-weight:500"> Customer Information</span>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" style="color: black;font-weight:bold" for="name">Name
