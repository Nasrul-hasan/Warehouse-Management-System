...
<body style="background-color:slategray" class="login">

    <div class="container back">
        {{-- <img src="{{ asset('images/wms.jpeg') }}" alt="Login Page Logo" style="background-size:cover;height:100vh;"> --}}
        <video autoplay muted loop id="background-video">
            <source src="{{ asset('images/warehouse.mp4') }}" type="video/mp4">
        ...
        <div class="login-box">
                    ...
                    <form action="{{route('login_user')}}" method="post">
                        ...
                        {{-- <a>
                            ...
                            <p>Contact administrator Reset the password</p>
                        </a> --}}

                        <a><p>Contact admin for Reset the password</p></a>
